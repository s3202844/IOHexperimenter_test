...
namespace ioh::problem::cec
{
    ...
    // void sum_diff_pow_func(double *x, double *f, int nx, double *Os, double
    // *Mr,
    //                        int s_flag, int r_flag)
    // {
    //     int i;
    ...
    // void weierstrass_func(double *x, double *f, int nx, double *Os, double
    // *Mr,
    //                       int s_flag, int r_flag)
    // {
    //     int i, j, k_max;
    ...
    //             0.5)); sum2 += pow(a, j) * cos(2.0 * M_PI * pow(b, j) * 0.5);
    //         }
    //         f[0] += sum;
    //     }
    //     f[0] -= nx * sum2;
    ...
    // void dixon_price_func(double *x, double *f, int nx, double *Os, double
    // *Mr,
    //                       int s_flag, int r_flag)
    // {
    //     int i;
